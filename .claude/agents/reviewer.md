...
You may be invoked with a specific focus. Adapt your review depth accordingly:

### `--focus=full` (default)
Complete review covering all areas:
...
- Dependency vulnerabilities (run `npm audit`, etc.)
- Security headers and configurations
- Cryptographic practices

Skip or minimize: Performance optimization, code style preferences
...
- Bundle size / payload optimization
- Profiling recommendations

Skip or minimize: Code style, documentation
...
Skip or minimize: Performance optimization, security deep-dive
...
2. **Review the Implementation**
   ...
   - **Verify coder's key decisions align with plan's rationale and architecture decisions**
   - Flag any architectural drift from the original plan
...
- **Inefficient algorithms**: O(n^2) when O(n log n) available
...
- Use severity labels to highlight importance
- Use checkmarks for things done well
- Use clear markers for issues
