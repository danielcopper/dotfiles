...
config.canonicalize_pasted_newlines = "LineFeed"  -- fix WSL paste (CRLF → LF)
config.allow_win32_input_mode = false              -- fix WSL paste flicker
-- config.default_prog = { "C:\\Users\\KueppermannD\\AppData\\Local\\Programs\\nu\\bin\\nu.exe" }
config.max_fps = 165
